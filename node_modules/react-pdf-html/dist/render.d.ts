...
export declare const renderElement: (element: HtmlElement | string, stylesheets: HtmlStyles[], renderers: HtmlRenderers, children?: any, index?: number | undefined) => ReactElement | string | string[];
export declare const renderElements: (elements: HtmlContent, options: HtmlRenderOptions, parentTag?: string | undefined) => ReactElement[];
